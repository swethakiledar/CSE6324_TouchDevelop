...
public class ProposalComputer {
	 ...
	 * */
	public List<ASTNode> getProposal(ExpressionStatement s) {
	 ...
	 * 
	 * insert statements of while, for, if, do...
	 * 
	 * params fields methods
	 * 
	 * */
	public List<ASTNode> getProposal(MethodDeclaration md) {
